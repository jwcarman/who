 ...
 *
 * <p>Constructed after successful JWT credential resolution. Marked authenticated on creation.
 * Credentials are not retained — the JWT has already been validated upstream by Spring Security's
