...
class JdbcRolePermissionRepositoryTest extends AbstractRbacTest {
  ...
  @Autowired private JdbcRoleRepository roleRepository;

  @Autowired private JdbcRolePermissionRepository permissionRepository;
  ...
  void removesPermission() {
    ...
    assertThat(permissionRepository.findPermissionsByRoleId(role.id())).containsOnly("EXECUTE");
  }
