...
public record Identity(UUID id, IdentityStatus status, Instant createdAt, Instant updatedAt) {
  ...
  /**
   * Creates a new {@code ACTIVE} {@code Identity} with a generated UUID and both timestamps set to
   * now.
   *
  ...
  /**
   * Returns a new {@code Identity} with the given status and an updated {@code updatedAt}
   * timestamp.
   *
